...
namespace GDAPS_Project_2
{
    class Player : MovableGameObject
    {
        ...
        // Depending on the frame, a random step sound is played.
        protected void CreateStepSounds()
        {
            if (frameIndex == 1 | frameIndex == 4 | frameIndex == 7 | frameIndex == 10 | frameIndex == 13)
            {
        ...
        /// <summary>
        /// Only draws the player if it is alive.
        /// </summary>
        /// <param name="s"></param>
